...
abstract class ColorsValue {
  static Color lightPrimaryColor = const Color(lightPrimary);

  static Color transparent = Colors.transparent;
  static Color primaryColor = const Color(0xffFFFFFF);
  static Color appColor = const Color(0xFF3E4095);
  static Color buttonColor = const Color(0xFF286AB0);
  ...
  static const colorDFDFDF = Color(0xffF8FAFC);
  ...
  static Color txtFieldColor = const Color(0xFF9BA0A8);
  static Color dark200E32 = const Color(0xFF200E32);
  static const colorD9D9D9 = Color(0xffD9D9D9);
  static Color greyE8EEEF = const Color(0xFFE8EEEF);
  static Color greyColor = const Color(0xFFEEEEEE);
  static Color orange = const Color(0xFFFC8415);
  static Color green = const Color(0xFF048746);
  static Color greyDDDDDD = const Color(0xFFDDDDDD);
  static Color grey939393 = const Color(0xFF939393);
  ...
  static const int lightPrimary = 0xffEBF1F8;
